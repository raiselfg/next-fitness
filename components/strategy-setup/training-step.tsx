...
import { TrainingStepInput, trainingStepSchema } from '@/schema/strategy';

interface TrainingStepProps {
  defaultValues?: Partial<TrainingStepInput>;
  onComplete: (data: TrainingStepInput) => void;
  onBack: () => void;
  isPending?: boolean;
}

export function TrainingStep({ defaultValues, onComplete, onBack, isPending }: TrainingStepProps) {
  const {
    register,
    control,
    handleSubmit,
  ...
  return (
    <form onSubmit={handleSubmit(onComplete)} className="flex flex-col grow">
